...
class SimulatorBaseListener(ParseTreeListener):
    ...
    def enter_method_call(self, ctx: SimulatorParser.MethodCallContext):
        pass

    # Exit a parse tree produced by SimulatorParser#methodCall.
    def exit_method_call(self, ctx: SimulatorParser.MethodCallContext):
        pass

    # Enter a parse tree produced by SimulatorParser#objectMethodCall.
    def enter_object_method_call(self, ctx: SimulatorParser.ObjectMethodCallContext):
        pass

    # Exit a parse tree produced by SimulatorParser#objectMethodCall.
    def exit_object_method_call(self, ctx: SimulatorParser.ObjectMethodCallContext):
        pass

    # Enter a parse tree produced by SimulatorParser#distribution.
    def enter_distribution(self, ctx: SimulatorParser.DistributionContext):
        pass

    # Exit a parse tree produced by SimulatorParser#distribution.
    def exit_distribution(self, ctx: SimulatorParser.DistributionContext):
        pass

    # Enter a parse tree produced by SimulatorParser#named_expression.
    def enter_named_expression(self, ctx: SimulatorParser.Named_expressionContext):
        pass

    # Exit a parse tree produced by SimulatorParser#named_expression.
    def exit_named_expression(self, ctx: SimulatorParser.Named_expressionContext):
        pass

    # Enter a parse tree produced by SimulatorParser#expression.
    def enter_expression(self, ctx: SimulatorParser.ExpressionContext):
        pass

    # Exit a parse tree produced by SimulatorParser#expression.
    def exit_expression(self, ctx: SimulatorParser.ExpressionContext):
        pass
